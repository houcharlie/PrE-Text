...
if __name__ == "__main__":
    ...
    batch_size = 2
    max_length = 20
    model = RobertaForMaskedLM.from_pretrained("roberta-large", torch_dtype=torch.float16)
    model = model.eval()
    ...
    accelerator.print(tokenizer.batch_decode(new_population, skip_special_tokens=True))
